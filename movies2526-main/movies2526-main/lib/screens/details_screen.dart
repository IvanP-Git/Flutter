                        ...
                        child: TabBarView(children: [
                          ...
                          FutureBuilder<List<Actor>?>( // Pestaña "Reparto"
                            ...
                            builder: (_, snapshot) {
                              ...
                              final cast = snapshot.data ?? []; // Obtener la lista de actores
                              if (cast.isEmpty) return const Center(child: Text('No cast found'));

                              return SizedBox(
                                height: 250,
                                child: ListView.builder( // Lista horizontal de actores
                                  scrollDirection: Axis.horizontal,
                                  itemCount: cast.length,
                                  itemBuilder: (_, index) {
                                    final actor = cast[index];

                                    return GestureDetector( // Al hacer clic en un actor, navegar a la pantalla de detalles del actor
                                          ...
                                          child: Column(
                                            children: [
                                              ClipRRect(
                                                ...
                                                : const SizedBox( // Mostrar icono de persona si no hay imagen
                                                  width: 120,
                                                  height: 160,
                                                  child: Center(
                                                    child: Icon(
